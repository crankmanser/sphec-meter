...
void UIManager::drawOledContent(OLED_ID oled, const OledProps& props, bool show_top_bar) {
    ...
    // Clear the specific content area, respecting the status bar
